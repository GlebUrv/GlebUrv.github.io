...
function setListeners(userCard) {
    ...
    changeBtn.addEventListener('click', () => {
        ...
        age.value = storage[userEmail].age
        const city = document.querySelector('#city')
        city.value = storage[userEmail].city
    })
}
...
function addCard(e) {
    ...
    if (storage[newEmail.value] !== undefined) {
        let emails = document.querySelectorAll('p.email')
        for (let i of emails) {
            if (i.innerText === newEmail.value) {
